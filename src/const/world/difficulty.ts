export const DIFFICULTY = {
  ...
  PLAYER_HEALTH: 1000, // Default player health
  PLAYER_HEALTH_GROWTH: 10, // Player health growth by level
  PLAYER_START_RESOURCES: 9000, // Player start resources
  ...
  ASSISTANT_SPEED: 160, // Default assistant speed
  ASSISTANT_SPEED_GROWTH: 0.5, // Assistant speed growth by player level
  ASSISTANT_HEALTH: 1000, // Default assistant health
  ASSISTANT_HEALTH_GROWTH: 20, // Assistant health growth by player level
  ...
  ASSISTANT_ATTACK_PAUSE_GROWTH: -0.01, // Attack pause growth by player level
  ...
  CHEST_SPAWN_FACTOR: 5, // Chest spawn factor
  CHEST_EXPERIENCE: 2, // Gained experience per open chest
  CHEST_EXPERIENCE_GROWTH: 0.3, // Experience growth by wave number
  CHEST_RESOURCES: 100, // Default resources count in chest
  CHEST_RESOURCES_GROWTH: 10, // Resources count growth by wave number
  ...
  BUILDING_TOWER_FIRE_ATTACK_RADIUS: 490, // Tower fire attack radius
  BUILDING_TOWER_FIRE_ATTACK_PAUSE: 10, // Tower fire pause between attacks
  ...
  BUILDING_TOWER_FROZEN_COST: 4, // Tower frozen cost
  ...
  BUILDING_GENERATOR_RESOURCES: 1500, // Maximum amount of resources that generator can
  ...
  BUILDING_AMMUNITION_RELOAD_RADIUS: 250, // Ammunition reload ammo radius
  BUILDING_AMMUNITION_AMMO: 1700, // Maximum amount of ammo
